...
import com.gchong3068.seckill.order.service.SeckillStockService;
...
public class SeckillStockServiceImpl implements SeckillStockService {
    ...
    public SeckillStockServiceImpl(DefaultRedisScript<Long> seckillPreDeductStockScript) {
        this.seckillPreDeductStockScript = seckillPreDeductStockScript;
     ...
     * @param activityId
     * @param goodsId
     * @return com.gchong3068.seckill.order.enums.SeckillStockDeductResultEnum
     */
    @Override
